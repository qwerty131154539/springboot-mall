...
public class ProductControllerTest {
    ...
    public void getProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productName", equalTo("幻月")))
    ...
    public void createProduct_success() throws Exception {
        ...
        productRequest.setProductName("test cookie product");
        productRequest.setCategory(ProductCategory.COOKIE);
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productName", equalTo("test cookie product")))
                .andExpect(jsonPath("$.category", equalTo("COOKIE")))
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.results[4].productId", equalTo(1)));
    }
